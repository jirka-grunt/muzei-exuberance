...
import static cz.ulmus.muzei.exuberance.ArtService.Photo;
import static cz.ulmus.muzei.exuberance.ArtService.PhotoResponse;
...
public class ArtSource extends RemoteMuzeiArtSource {
	...
	protected void onTryUpdate(int reason) throws RetryException {
		...
		final String sizePref = sharedPref.getString(SettingsActivity.KEY_PREF_SIZE, "smaller");
		...
		RestAdapter restAdapter = new RestAdapter.Builder()
				...
				.setRequestInterceptor(new RequestInterceptor() {
					...
					public void intercept(RequestFacade request) {
						request.addQueryParam("size", sizePref);
					}
				})
